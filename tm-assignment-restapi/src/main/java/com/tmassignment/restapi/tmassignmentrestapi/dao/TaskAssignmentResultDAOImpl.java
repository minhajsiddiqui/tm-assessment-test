...
public class TaskAssignmentResultDAOImpl implements ITaskAssignmentResultDAO {
	...
	public List<AssignmentResult> findAll() {
		...
		// create a query
		final Query theQuery = entityManager.createQuery("from assignmentResult");
	...
	public void deleteById(final int theId) {
		...
		final Query theQuery = entityManager.createQuery("delete from assignmentResult where id=:assignmentResultId");
